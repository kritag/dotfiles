...
hl.window_rule({
    name = "opacity-90",
    match = { class = "^(spotify|org.gnome.Calculator|org.gnome.Nautilus|org.kde.dolphin|steam|discord|Thunar|thunar|net.lutris.Lutris|org.gnome.Calendar|pcmanfm|Rofi|xdg-desktop-portal-gtk|org.qbittorrent.qBittorrent)$" },
    opacity = "0.90 0.90",
})
...
hl.window_rule({
    name  = "float-apps",
    match = { class = "^(org.gnome.Calculator|org.gnome.TextEditor|org.gnome.Loupe|org.gnome.font-viewer|org.gnome.Calendar|org.kde.dolphin|org.gnome.Nautilus|Thunar|thunar|Keybase|Rofi|org.quickshell|one.alynx.showmethekey|showmethekey-gtk|com.vysp3r.ProtonPlus|xdg-desktop-portal-gtk)$" },
    float  = true,
    center = true,
})
...
hl.window_rule({
    match = { class = "^(gnome-system-monitor|org.gnome.SystemMonitor|io.missioncenter.MissionCenter|xdg-desktop-portal-gtk)$" },
